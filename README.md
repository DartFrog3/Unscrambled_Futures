# Unscrambled_Futures
*Sandbox of classical time-series forecasting (ARIMA, SARIMAX) and machine learning models (XGBoost, LSTM, TFT) incorporating real-time agentic news reasoning and sentiment analysis for automated trading within the US egg market.*
